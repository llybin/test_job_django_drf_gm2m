            ...
            response.json(),
            {
                ...
                'results': [
                    ...
                    },
                    {
                        ...
                        'created_at': '2019-04-22T21:44:38.644000Z',
                        'modified_at': '2019-04-22T21:44:38.644000Z'
                    }
                ]
            }
        )
                ...
                'results': [
                    {
                        ...
                        'created_at': '2019-04-22T21:44:32.887000Z',
                        'modified_at': '2019-04-22T21:44:32.887000Z'
                    }
                ]
            }
        )
...
class PageDetailTest(TestCase):
    ...
    def test_first_content(self):
        ...
        self.assertEqual(content_text['id'], 2)
        self.assertEqual(content_text['title'], 'The second text')
        self.assertEqual(content_text['created_at'], '2019-04-22T21:43:13.455000Z')
        self.assertEqual(content_text['text'], 'blabla text for second')
        self.assertEqual(content_text['type'], 'text')
    ...
    def test_counter(self):
        ...
        for x in content:
            counters[(x['id'], x['type'])] = x['counter']
        ...
        for x in content:
            self.assertIn((x['id'], x['type']), counters)
            self.assertEqual(x['counter'], counters[(x['id'], x['type'])] + 1)
